...
import org.l2jbr_unity.gameserver.network.serverpackets.ExOlympiadMatchList;
	...
	public boolean useBypass(String command, Player player, Creature target)
	{
		try
		{
			...
			else
			{
				...
				if (org.l2jbr_unity.gameserver.model.olympiad.OlympiadManager.getInstance().isRegisteredInComp(player))
				{
