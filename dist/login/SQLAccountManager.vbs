...
'Run the installer.
shell.Run "cmd /c start ""L2J BrUnity - SQL Account Manager"" " & path & "java -Djava.util.logging.config.file=console.cfg -cp ./../libs/* org.l2jbr_unity.tools.accountmanager.SQLAccountManager", 1, False
