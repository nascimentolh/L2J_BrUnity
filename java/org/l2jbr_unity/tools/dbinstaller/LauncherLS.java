 ...
 */
package org.l2jbr_unity.tools.dbinstaller;
...
import org.l2jbr_unity.tools.dbinstaller.console.DBInstallerConsole;
import org.l2jbr_unity.tools.dbinstaller.gui.DBConfigGUI;
...
public class LauncherLS extends AbstractDBLauncher
{
	public static void main(String[] args) throws Exception
	{
		...
		final String defDatabase = "l2jbr_unityh5";
