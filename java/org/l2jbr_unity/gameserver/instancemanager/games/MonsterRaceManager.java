...
import org.l2jbr_unity.gameserver.network.serverpackets.MonRaceInfo;
	...
	public void newRace()
	{
		...
		for (int i = 0; i < 8; i++)
		{
			try
			{
				...
				_monsters[i] = (Npc) Class.forName("org.l2jbr_unity.gameserver.model.actor.instance." + template.getType()).getConstructors()[0].newInstance(template);
			}
			catch (Exception e)
			{
