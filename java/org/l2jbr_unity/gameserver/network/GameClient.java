...
import org.l2jbr_unity.gameserver.LoginServerThread.SessionKey;
...
import org.l2jbr_unity.gameserver.security.SecondaryPasswordAuth;
import org.l2jbr_unity.gameserver.util.FloodProtectors;

/**
 * Represents a client connected on GameServer.
 * @author KenM
 */
public class GameClient extends Client<org.l2jbr_unity.commons.network.Connection<GameClient>>
{
	...
	public GameClient(org.l2jbr_unity.commons.network.Connection<GameClient> connection)
	{
		super(connection);
