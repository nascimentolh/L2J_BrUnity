...
import static org.l2jbr_unity.gameserver.ai.CtrlIntention.AI_INTENTION_ACTIVE;
import static org.l2jbr_unity.gameserver.ai.CtrlIntention.AI_INTENTION_ATTACK;
...
import org.l2jbr_unity.commons.util.EmptyQueue;
...
import org.l2jbr_unity.gameserver.ai.CreatureAI.IntentionCommand;
...
import org.l2jbr_unity.gameserver.data.xml.FenceData;
...
import org.l2jbr_unity.gameserver.instancemanager.CaptchaManager;
...
import org.l2jbr_unity.gameserver.model.EffectList;
...
import org.l2jbr_unity.gameserver.model.WorldRegion;
import org.l2jbr_unity.gameserver.model.actor.instance.GrandBoss;
import org.l2jbr_unity.gameserver.model.actor.instance.Monster;
import org.l2jbr_unity.gameserver.model.actor.instance.Pet;
import org.l2jbr_unity.gameserver.model.actor.instance.QuestGuard;
import org.l2jbr_unity.gameserver.model.actor.stat.CreatureStat;
import org.l2jbr_unity.gameserver.model.actor.status.CreatureStatus;
import org.l2jbr_unity.gameserver.model.actor.tasks.creature.HitTask;
import org.l2jbr_unity.gameserver.model.actor.tasks.creature.MagicUseTask;
import org.l2jbr_unity.gameserver.model.actor.tasks.creature.NotifyAITask;
import org.l2jbr_unity.gameserver.model.actor.tasks.creature.QueuedMagicUseTask;
...
import org.l2jbr_unity.gameserver.model.actor.transform.TransformTemplate;
...
import org.l2jbr_unity.gameserver.model.holders.InvulSkillHolder;
...
import org.l2jbr_unity.gameserver.model.interfaces.IDeletable;
import org.l2jbr_unity.gameserver.model.interfaces.ILocational;
import org.l2jbr_unity.gameserver.model.interfaces.ISkillsHolder;
...
import org.l2jbr_unity.gameserver.model.options.OptionSkillType;
...
import org.l2jbr_unity.gameserver.model.skill.BuffFinishTask;
...
import org.l2jbr_unity.gameserver.model.skill.SkillChannelized;
import org.l2jbr_unity.gameserver.model.skill.SkillChannelizer;
import org.l2jbr_unity.gameserver.model.skill.targets.TargetType;
import org.l2jbr_unity.gameserver.model.stats.BaseStat;
import org.l2jbr_unity.gameserver.model.stats.Calculator;
...
import org.l2jbr_unity.gameserver.network.serverpackets.AbstractNpcInfo;
import org.l2jbr_unity.gameserver.network.serverpackets.ActionFailed;
import org.l2jbr_unity.gameserver.network.serverpackets.Attack;
import org.l2jbr_unity.gameserver.network.serverpackets.ChangeMoveType;
import org.l2jbr_unity.gameserver.network.serverpackets.ChangeWaitType;
import org.l2jbr_unity.gameserver.network.serverpackets.ExRotation;
import org.l2jbr_unity.gameserver.network.serverpackets.FakePlayerInfo;
import org.l2jbr_unity.gameserver.network.serverpackets.FlyToLocation;
import org.l2jbr_unity.gameserver.network.serverpackets.MagicSkillCanceled;
import org.l2jbr_unity.gameserver.network.serverpackets.MagicSkillLaunched;
import org.l2jbr_unity.gameserver.network.serverpackets.MagicSkillUse;
import org.l2jbr_unity.gameserver.network.serverpackets.MoveToLocation;
import org.l2jbr_unity.gameserver.network.serverpackets.MoveToPawn;
import org.l2jbr_unity.gameserver.network.serverpackets.Revive;
import org.l2jbr_unity.gameserver.network.serverpackets.ServerObjectInfo;
...
import org.l2jbr_unity.gameserver.network.serverpackets.TeleportToLocation;
import org.l2jbr_unity.gameserver.taskmanager.AttackStanceTaskManager;
import org.l2jbr_unity.gameserver.taskmanager.CreatureSeeTaskManager;
import org.l2jbr_unity.gameserver.taskmanager.GameTimeTaskManager;
import org.l2jbr_unity.gameserver.taskmanager.MovementTaskManager;
