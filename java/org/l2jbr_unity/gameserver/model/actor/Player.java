 ...
 */
package org.l2jbr_unity.gameserver.model.actor;
...
import org.l2jbr_unity.gameserver.LoginServerThread;
import org.l2jbr_unity.gameserver.ai.CreatureAI;
import org.l2jbr_unity.gameserver.ai.CtrlIntention;
import org.l2jbr_unity.gameserver.ai.PlayerAI;
import org.l2jbr_unity.gameserver.ai.SummonAI;
import org.l2jbr_unity.gameserver.cache.RelationCache;
import org.l2jbr_unity.gameserver.communitybbs.BB.Forum;
import org.l2jbr_unity.gameserver.communitybbs.Manager.ForumsBBSManager;
import org.l2jbr_unity.gameserver.data.sql.CharInfoTable;
import org.l2jbr_unity.gameserver.data.sql.CharSummonTable;
...
import org.l2jbr_unity.gameserver.data.xml.CategoryData;
import org.l2jbr_unity.gameserver.data.xml.ClassListData;
...
import org.l2jbr_unity.gameserver.data.xml.FishData;
...
import org.l2jbr_unity.gameserver.data.xml.PlayerTemplateData;
import org.l2jbr_unity.gameserver.data.xml.PlayerXpPercentLostData;
...
import org.l2jbr_unity.gameserver.enums.CategoryType;
...
import org.l2jbr_unity.gameserver.enums.IllegalActionPunishmentType;
...
import org.l2jbr_unity.gameserver.enums.PartyDistributionType;
...
import org.l2jbr_unity.gameserver.enums.ShortcutType;
...
import org.l2jbr_unity.gameserver.instancemanager.CoupleManager;
...
import org.l2jbr_unity.gameserver.instancemanager.GrandBossManager;
import org.l2jbr_unity.gameserver.instancemanager.HandysBlockCheckerManager;
import org.l2jbr_unity.gameserver.instancemanager.IdManager;
import org.l2jbr_unity.gameserver.instancemanager.InstanceManager;
import org.l2jbr_unity.gameserver.instancemanager.ItemsOnGroundManager;
import org.l2jbr_unity.gameserver.instancemanager.PunishmentManager;
import org.l2jbr_unity.gameserver.instancemanager.QuestManager;
import org.l2jbr_unity.gameserver.instancemanager.RecipeManager;
...
import org.l2jbr_unity.gameserver.model.ArenaParticipantsHolder;
import org.l2jbr_unity.gameserver.model.BlockList;
import org.l2jbr_unity.gameserver.model.ContactList;
...
import org.l2jbr_unity.gameserver.model.MacroList;
import org.l2jbr_unity.gameserver.model.ManufactureItem;
import org.l2jbr_unity.gameserver.model.Nevit;
import org.l2jbr_unity.gameserver.model.Party;
import org.l2jbr_unity.gameserver.model.PetLevelData;
import org.l2jbr_unity.gameserver.model.PremiumItem;
import org.l2jbr_unity.gameserver.model.Radar;
import org.l2jbr_unity.gameserver.model.RecipeList;
import org.l2jbr_unity.gameserver.model.Request;
import org.l2jbr_unity.gameserver.model.ShortCuts;
...
import org.l2jbr_unity.gameserver.model.TimeStamp;
...
import org.l2jbr_unity.gameserver.model.actor.appearance.PlayerAppearance;
import org.l2jbr_unity.gameserver.model.actor.instance.AirShip;
import org.l2jbr_unity.gameserver.model.actor.instance.Boat;
import org.l2jbr_unity.gameserver.model.actor.instance.ClassMaster;
import org.l2jbr_unity.gameserver.model.actor.instance.ControlTower;
import org.l2jbr_unity.gameserver.model.actor.instance.Cubic;
...
import org.l2jbr_unity.gameserver.model.actor.instance.EventMonster;
import org.l2jbr_unity.gameserver.model.actor.instance.FriendlyMob;
import org.l2jbr_unity.gameserver.model.actor.instance.Guard;
import org.l2jbr_unity.gameserver.model.actor.instance.Pet;
import org.l2jbr_unity.gameserver.model.actor.instance.TamedBeast;
import org.l2jbr_unity.gameserver.model.actor.instance.Trap;
import org.l2jbr_unity.gameserver.model.actor.stat.PlayerStat;
import org.l2jbr_unity.gameserver.model.actor.status.PlayerStatus;
import org.l2jbr_unity.gameserver.model.actor.tasks.player.DismountTask;
import org.l2jbr_unity.gameserver.model.actor.tasks.player.FameTask;
import org.l2jbr_unity.gameserver.model.actor.tasks.player.InventoryEnableTask;
import org.l2jbr_unity.gameserver.model.actor.tasks.player.LookingForFishTask;
import org.l2jbr_unity.gameserver.model.actor.tasks.player.PetFeedTask;
import org.l2jbr_unity.gameserver.model.actor.tasks.player.RecoBonusTaskEnd;
import org.l2jbr_unity.gameserver.model.actor.tasks.player.RecoGiveTask;
import org.l2jbr_unity.gameserver.model.actor.tasks.player.RentPetTask;
import org.l2jbr_unity.gameserver.model.actor.tasks.player.ResetChargesTask;
import org.l2jbr_unity.gameserver.model.actor.tasks.player.ResetSoulsTask;
import org.l2jbr_unity.gameserver.model.actor.tasks.player.SitDownTask;
import org.l2jbr_unity.gameserver.model.actor.tasks.player.StandUpTask;
import org.l2jbr_unity.gameserver.model.actor.tasks.player.TeleportWatchdogTask;
import org.l2jbr_unity.gameserver.model.actor.tasks.player.VitalityTask;
import org.l2jbr_unity.gameserver.model.actor.tasks.player.WarnUserTakeBreakTask;
import org.l2jbr_unity.gameserver.model.actor.tasks.player.WaterTask;
import org.l2jbr_unity.gameserver.model.actor.templates.PlayerTemplate;
import org.l2jbr_unity.gameserver.model.actor.transform.Transform;
...
import org.l2jbr_unity.gameserver.model.events.impl.creature.playable.OnPlayableExpChanged;
import org.l2jbr_unity.gameserver.model.events.impl.creature.player.OnPlayerFameChanged;
import org.l2jbr_unity.gameserver.model.events.impl.creature.player.OnPlayerHennaRemove;
import org.l2jbr_unity.gameserver.model.events.impl.creature.player.OnPlayerItemEquip;
import org.l2jbr_unity.gameserver.model.events.impl.creature.player.OnPlayerKarmaChanged;
...
import org.l2jbr_unity.gameserver.model.events.impl.creature.player.OnPlayerPKChanged;
import org.l2jbr_unity.gameserver.model.events.impl.creature.player.OnPlayerProfessionCancel;
import org.l2jbr_unity.gameserver.model.events.impl.creature.player.OnPlayerProfessionChange;
import org.l2jbr_unity.gameserver.model.events.impl.creature.player.OnPlayerPvPChanged;
import org.l2jbr_unity.gameserver.model.events.impl.creature.player.OnPlayerPvPKill;
import org.l2jbr_unity.gameserver.model.events.impl.creature.player.OnPlayerTransform;
import org.l2jbr_unity.gameserver.model.events.listeners.FunctionEventListener;
import org.l2jbr_unity.gameserver.model.events.returns.TerminateReturn;
import org.l2jbr_unity.gameserver.model.events.timers.TimerHolder;
import org.l2jbr_unity.gameserver.model.fishing.Fish;
import org.l2jbr_unity.gameserver.model.fishing.Fishing;
import org.l2jbr_unity.gameserver.model.holders.AdditionalSkillHolder;
import org.l2jbr_unity.gameserver.model.holders.AutoPlaySettingsHolder;
import org.l2jbr_unity.gameserver.model.holders.AutoUseSettingsHolder;
import org.l2jbr_unity.gameserver.model.holders.ItemHolder;
import org.l2jbr_unity.gameserver.model.holders.MovieHolder;
import org.l2jbr_unity.gameserver.model.holders.SellBuffHolder;
import org.l2jbr_unity.gameserver.model.holders.SkillHolder;
import org.l2jbr_unity.gameserver.model.holders.SkillUseHolder;
import org.l2jbr_unity.gameserver.model.holders.SubClassHolder;
import org.l2jbr_unity.gameserver.model.instancezone.Instance;
import org.l2jbr_unity.gameserver.model.interfaces.IEventListener;
import org.l2jbr_unity.gameserver.model.interfaces.ILocational;
import org.l2jbr_unity.gameserver.model.item.Armor;
...
import org.l2jbr_unity.gameserver.model.item.type.ActionType;
import org.l2jbr_unity.gameserver.model.item.type.ArmorType;
import org.l2jbr_unity.gameserver.model.item.type.EtcItemType;
...
import org.l2jbr_unity.gameserver.model.itemcontainer.PetInventory;
import org.l2jbr_unity.gameserver.model.itemcontainer.PlayerFreight;
import org.l2jbr_unity.gameserver.model.itemcontainer.PlayerInventory;
import org.l2jbr_unity.gameserver.model.itemcontainer.PlayerRefund;
...
import org.l2jbr_unity.gameserver.model.multisell.PreparedListContainer;
import org.l2jbr_unity.gameserver.model.olympiad.Hero;
import org.l2jbr_unity.gameserver.model.olympiad.OlympiadGameManager;
import org.l2jbr_unity.gameserver.model.olympiad.OlympiadGameTask;
...
import org.l2jbr_unity.gameserver.model.variables.AccountVariables;
import org.l2jbr_unity.gameserver.model.variables.PlayerVariables;
import org.l2jbr_unity.gameserver.model.zone.ZoneId;
import org.l2jbr_unity.gameserver.model.zone.ZoneRegion;
import org.l2jbr_unity.gameserver.model.zone.ZoneType;
import org.l2jbr_unity.gameserver.model.zone.type.BossZone;
import org.l2jbr_unity.gameserver.model.zone.type.WaterZone;
...
import org.l2jbr_unity.gameserver.network.serverpackets.AbstractHtmlPacket;
import org.l2jbr_unity.gameserver.network.serverpackets.ActionFailed;
import org.l2jbr_unity.gameserver.network.serverpackets.ChangeWaitType;
import org.l2jbr_unity.gameserver.network.serverpackets.CharInfo;
import org.l2jbr_unity.gameserver.network.serverpackets.ConfirmDlg;
import org.l2jbr_unity.gameserver.network.serverpackets.EtcStatusUpdate;
import org.l2jbr_unity.gameserver.network.serverpackets.ExAutoSoulShot;
import org.l2jbr_unity.gameserver.network.serverpackets.ExBrExtraUserInfo;
import org.l2jbr_unity.gameserver.network.serverpackets.ExDuelUpdateUserInfo;
import org.l2jbr_unity.gameserver.network.serverpackets.ExFishingEnd;
import org.l2jbr_unity.gameserver.network.serverpackets.ExFishingStart;
import org.l2jbr_unity.gameserver.network.serverpackets.ExGetBookMarkInfoPacket;
import org.l2jbr_unity.gameserver.network.serverpackets.ExGetOnAirShip;
import org.l2jbr_unity.gameserver.network.serverpackets.ExOlympiadMode;
import org.l2jbr_unity.gameserver.network.serverpackets.ExPrivateStoreSetWholeMsg;
import org.l2jbr_unity.gameserver.network.serverpackets.ExSetCompassZoneCode;
import org.l2jbr_unity.gameserver.network.serverpackets.ExStartScenePlayer;
import org.l2jbr_unity.gameserver.network.serverpackets.ExStorageMaxCount;
import org.l2jbr_unity.gameserver.network.serverpackets.ExUseSharedGroupItem;
import org.l2jbr_unity.gameserver.network.serverpackets.ExVoteSystemInfo;
import org.l2jbr_unity.gameserver.network.serverpackets.FriendStatusPacket;
import org.l2jbr_unity.gameserver.network.serverpackets.GetOnVehicle;
import org.l2jbr_unity.gameserver.network.serverpackets.HennaInfo;
import org.l2jbr_unity.gameserver.network.serverpackets.InventoryUpdate;
import org.l2jbr_unity.gameserver.network.serverpackets.ItemList;
import org.l2jbr_unity.gameserver.network.serverpackets.LeaveWorld;
import org.l2jbr_unity.gameserver.network.serverpackets.MagicSkillUse;
import org.l2jbr_unity.gameserver.network.serverpackets.MyTargetSelected;
import org.l2jbr_unity.gameserver.network.serverpackets.NicknameChanged;
import org.l2jbr_unity.gameserver.network.serverpackets.ObservationMode;
import org.l2jbr_unity.gameserver.network.serverpackets.ObservationReturn;
import org.l2jbr_unity.gameserver.network.serverpackets.PartySmallWindowUpdate;
import org.l2jbr_unity.gameserver.network.serverpackets.PetInventoryUpdate;
import org.l2jbr_unity.gameserver.network.serverpackets.PlaySound;
import org.l2jbr_unity.gameserver.network.serverpackets.PledgeShowMemberListDelete;
import org.l2jbr_unity.gameserver.network.serverpackets.PledgeShowMemberListUpdate;
import org.l2jbr_unity.gameserver.network.serverpackets.PrivateStoreListBuy;
import org.l2jbr_unity.gameserver.network.serverpackets.PrivateStoreListSell;
import org.l2jbr_unity.gameserver.network.serverpackets.PrivateStoreManageListBuy;
import org.l2jbr_unity.gameserver.network.serverpackets.PrivateStoreManageListSell;
import org.l2jbr_unity.gameserver.network.serverpackets.PrivateStoreMsgBuy;
import org.l2jbr_unity.gameserver.network.serverpackets.PrivateStoreMsgSell;
import org.l2jbr_unity.gameserver.network.serverpackets.RecipeShopMsg;
import org.l2jbr_unity.gameserver.network.serverpackets.RecipeShopSellList;
import org.l2jbr_unity.gameserver.network.serverpackets.RelationChanged;
import org.l2jbr_unity.gameserver.network.serverpackets.Ride;
import org.l2jbr_unity.gameserver.network.serverpackets.ServerPacket;
import org.l2jbr_unity.gameserver.network.serverpackets.SetupGauge;
import org.l2jbr_unity.gameserver.network.serverpackets.ShortCutInit;
import org.l2jbr_unity.gameserver.network.serverpackets.SkillCoolTime;
import org.l2jbr_unity.gameserver.network.serverpackets.SkillList;
import org.l2jbr_unity.gameserver.network.serverpackets.Snoop;
...
import org.l2jbr_unity.gameserver.network.serverpackets.StopMove;
import org.l2jbr_unity.gameserver.network.serverpackets.SystemMessage;
import org.l2jbr_unity.gameserver.network.serverpackets.TargetSelected;
import org.l2jbr_unity.gameserver.network.serverpackets.TargetUnselected;
import org.l2jbr_unity.gameserver.network.serverpackets.TradeDone;
import org.l2jbr_unity.gameserver.network.serverpackets.TradeOtherDone;
import org.l2jbr_unity.gameserver.network.serverpackets.TradeStart;
import org.l2jbr_unity.gameserver.network.serverpackets.UserInfo;
...
import org.l2jbr_unity.gameserver.taskmanager.DecayTaskManager;
import org.l2jbr_unity.gameserver.taskmanager.GameTimeTaskManager;
import org.l2jbr_unity.gameserver.taskmanager.ItemsAutoDestroyTaskManager;
import org.l2jbr_unity.gameserver.taskmanager.PlayerAutoSaveTaskManager;
import org.l2jbr_unity.gameserver.taskmanager.PvpFlagTaskManager;
import org.l2jbr_unity.gameserver.util.Broadcast;
import org.l2jbr_unity.gameserver.util.EnumIntBitmask;
