...
import org.l2jbr_unity.gameserver.instancemanager.PcCafePointsManager;
...
import org.l2jbr_unity.gameserver.model.events.annotations.Id;
import org.l2jbr_unity.gameserver.model.events.annotations.Ids;
import org.l2jbr_unity.gameserver.model.events.annotations.NpcLevelRange;
import org.l2jbr_unity.gameserver.model.events.annotations.NpcLevelRanges;
import org.l2jbr_unity.gameserver.model.events.annotations.Priority;
import org.l2jbr_unity.gameserver.model.events.annotations.Range;
import org.l2jbr_unity.gameserver.model.events.annotations.Ranges;
import org.l2jbr_unity.gameserver.model.events.annotations.RegisterEvent;
import org.l2jbr_unity.gameserver.model.events.annotations.RegisterType;
...
import org.l2jbr_unity.gameserver.model.events.listeners.AnnotationEventListener;
import org.l2jbr_unity.gameserver.model.events.listeners.ConsumerEventListener;
import org.l2jbr_unity.gameserver.model.events.listeners.DummyEventListener;
import org.l2jbr_unity.gameserver.model.events.listeners.FunctionEventListener;
import org.l2jbr_unity.gameserver.model.events.listeners.RunnableEventListener;
import org.l2jbr_unity.gameserver.model.events.returns.AbstractEventReturn;
import org.l2jbr_unity.gameserver.model.events.returns.TerminateReturn;
import org.l2jbr_unity.gameserver.model.events.timers.IEventTimerCancel;
import org.l2jbr_unity.gameserver.model.events.timers.IEventTimerEvent;
...
import org.l2jbr_unity.gameserver.model.itemcontainer.Mail;
...
import org.l2jbr_unity.gameserver.network.serverpackets.SpecialCamera;
...
import org.l2jbr_unity.gameserver.scripting.ManagedScript;
import org.l2jbr_unity.gameserver.taskmanager.GameTimeTaskManager;
import org.l2jbr_unity.gameserver.util.MinionList;
...
public abstract class AbstractScript extends ManagedScript implements IEventTimerEvent<String>, IEventTimerCancel<String>
{
	...
	/**
	 * Provides delayed (Depending on {@link org.l2jbr_unity.gameserver.model.actor.Attackable#getOnKillDelay()}) callback operation when Attackable dies from a player.
	 * @param callback
	 * @param npcIds
	 * @return
	 */
	...
	/**
	 * Provides instant callback operation when {@link org.l2jbr_unity.gameserver.model.actor.Creature} Enters on a {@link ZoneType}.
	 * @param callback
	 * @param npcIds
	 * @return
	 */
	...
	/**
	 * Provides instant callback operation when {@link org.l2jbr_unity.gameserver.model.actor.Creature} Exits on a {@link ZoneType}.
	 * @param callback
	 * @param npcIds
	 * @return
	 */
	...
	/**
	 * Provides instant callback operation when {@link org.l2jbr_unity.gameserver.model.actor.instance.Trap} acts.
	 * @param callback
	 * @param npcIds
	 * @return
	 */
	 ...
	 * Use this method instead of importing {@link org.l2jbr_unity.commons.util.Rnd} utility.
	...
	/**
	 * @return the number of ticks from the {@link org.l2jbr_unity.gameserver.taskmanager.GameTimeTaskManager}.
	 */
