...
import org.l2jbr_unity.gameserver.enums.StatFunction;
...
public class FuncTemplate
{
	...
	public FuncTemplate(Condition attachCond, Condition applyCond, String functionName, int order, Stat stat, double value)
	{
		...
		try
		{
			final Class<?> functionClass = Class.forName("org.l2jbr_unity.gameserver.model.stats.functions.Func" + function.getName());
