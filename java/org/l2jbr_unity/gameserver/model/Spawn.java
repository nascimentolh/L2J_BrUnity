...
import org.l2jbr_unity.gameserver.taskmanager.RespawnTaskManager;
...
public class Spawn extends Location implements IIdentifiable, INamable
{
	...
	public Spawn(NpcTemplate template) throws ClassNotFoundException, NoSuchMethodException, ClassCastException
	{
		...
		_constructor = Class.forName("org.l2jbr_unity.gameserver.model.actor.instance." + _template.getType()).asSubclass(Npc.class).getConstructor(NpcTemplate.class);
	}
